...
Insgesamt lassen sich nur geringe Veränderungen über Zeit feststellen: Die Befragten, die in Deutschland geboren wurden, nehmen nur marginal ab. Proportional nimmt der Anteil der im Ausland geborenen zu, mit einem Höchststand von circa 20% in 2019. Von diesen kommen etwas mehr aus EU-Drittstaaten (also Ländern, die mit Stand 2020 nicht EU-Mitglied sind) als aus der EU (Stand 2020, also ohne UK). Anzumerken ist, dass die Daten für 2020 nur Provisorisch sind.
...
# Analyse der wohnungsbedingter Problemlagen für Berlin
