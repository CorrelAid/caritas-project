...
setwd("~/CorrelAid/Referenzwerte_SILC/Haushaltsstruktur 3/ilc_lvps02(3)")

data_haushalt2 <- read.csv2("ilc_lvps02_1_Data.csv",na="NA", sep=",", dec=",")
...
rm(df6, Familienstand_Alle, Familienstand_Armutsgrenze)
